...
public class products_lp extends AppCompatActivity {

    WebView webView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_products_lp);
        ...
        homebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                final Intent intent = new Intent(products_lp.this.getApplicationContext(), MainActivity.class);
                products_lp.this.startActivity(intent);
            }
        });
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                final WebView browser = products_lp.this.findViewById(R.id.webView);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(final WebView view, final String url, final Bitmap favicon) {
            ...
            if (url.startsWith("http://open/smsactivity/")) {
                final Intent intent1 = new Intent(products_lp.this.getApplicationContext(), choose_send_option.class);
                products_lp.this.startActivity(intent1);
            }
        }
        ...
        public  boolean shouldOverrideUrlLoading(final WebView view, final WebResourceRequest request){
            ...
            if (clicked_url.startsWith("http://open/smsactivity/")) {
                ...
                final GlobalClass globalClass = (GlobalClass) products_lp.this.getApplicationContext();
    ...
    public void onBackPressed() {
        final WebView browser = this.findViewById(R.id.webView);
        if (browser.canGoBack()) {
            browser.goBack();
        } else {
