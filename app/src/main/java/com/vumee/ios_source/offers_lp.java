    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                final Intent intent = new Intent(offers_lp.this.getApplicationContext(), MainActivity.class);
                offers_lp.this.startActivity(intent);
            }
        });
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                final WebView browser = offers_lp.this.findViewById(R.id.webView);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(final WebView view, final String url, final Bitmap favicon) {
            ...
            if (url.startsWith("http://open/smsactivity/")) {
                final Intent intent1 = new Intent(offers_lp.this.getApplicationContext(), choose_send_option.class);
                offers_lp.this.startActivity(intent1);
            }
        }
        ...
        public  boolean shouldOverrideUrlLoading(final WebView view, final WebResourceRequest request){
            ...
            if (clicked_url.startsWith("http://open/smsactivity/")) {
                 ...
                 GlobalClass globalClass = (GlobalClass) offers_lp.this.getApplicationContext();
